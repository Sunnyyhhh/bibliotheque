...
<%@ page import="com.example.demo.entities.Adherent" %>
...
<body>
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/utilisateurs/inscription" method="post">
            ...
            <div class="input-group">
                ...
                <select id="idAdherent" name="idAdherent">
                    <% 
                        List<Adherent> ads = (List<Adherent>) request.getAttribute("adherents");
                        for (Adherent ad : ads) {
                    %>
                        <option value="<%= ad.getId_Adherent() %>"><%= ad.getNom_Adherent() %></option>
                    <% } %>
                </select>
            </div>
            <div class="input-group">
